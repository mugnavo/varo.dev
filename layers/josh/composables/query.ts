...
import type { ConfirmParams, QueryInfer, QueryState } from "@/components/DynamicForm/types";
...
export const useQuery = (args?: QueryState) => {
    ...
    ): Promise<(Schema extends Record<string, never> ? true : QueryInfer<Schema>) | null> => {
